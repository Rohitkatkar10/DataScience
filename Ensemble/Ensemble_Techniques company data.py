# -*- coding: utf-8 -*-
"""
Created on Wed Apr 13 17:37:25 2022
...
data = pd.read_excel(r"D:\360digitmg\lectures\19 Ensemble Techniques\Assignment\Datasets\Coca_Rating_Ensemble.xlsx")
...
# since the categorical col has more than 1000 discrete elements init. it is not possible convert all them into dummy columns
# since data dimension will increase. we can use PCA, but i dont see any use of it.

# hence drop all categorical columns
col = cat_col
...
features = data.iloc[:, data.columns != 'Rating']
label = data['Rating']   
label = label.astype('O')   
# split the data 
