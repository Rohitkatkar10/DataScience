# -*- coding: utf-8 -*-
"""
Created on Wed Apr 27 23:25:30 2022

@author: rohit
"""

# Forcasting Assignment on solar data
...
# load the data
data = pd.read_csv(r'D:\360digitmg\lectures\31 Forcasting - Time Series\Assignment\Datasets_Forecasting\solarpower_cumuldaybyday2.csv')
data.columns  
data.head()
...
MAPE(pred_hwe_add_add, Test.cum_power) # least error
# 0.06746394721880301
