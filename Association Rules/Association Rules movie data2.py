# -*- coding: utf-8 -*-
"""
Created on Tue Mar 29 18:29:45 2022
...
mov_df = pd.get_dummies(movies)


# Apriori.
from mlxtend.frequent_patterns import apriori, association_rules
frequent_itemsets = apriori(mov_df, min_support=0.075, max_len=4, use_colnames=True) #min support is 75 times. (75/10000) by supprt formula.
